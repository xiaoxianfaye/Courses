...
class TestMeasuresystemUI(unittest.TestCase):
    ...
    def test_parse_quantity(self):
        self.assertEquals([1, 2, 3, 4], parse_quantity(' 1 Mile  2 Yard 3 Feet 4 Inch  ', TestMeasuresystemUI.SYSUNITS))
        self.assertEquals([1, 2, 0, 4], parse_quantity('1 Mile 4 Inch 2 Yard', TestMeasuresystemUI.SYSUNITS))
        self.assertEquals([1, 2, 0, 4], parse_quantity('1 Mile 2 Yard 4 Inch', TestMeasuresystemUI.SYSUNITS))
        self.assertEquals([0, 0, 3, 0], parse_quantity('3 Feet', TestMeasuresystemUI.SYSUNITS))
    ...
    def test_scale(self):
        self.assertEquals('6 Yard 0 Inch',
                          scale('2', '2 Yard 3 Feet',
                                TestMeasuresystemUI.SYSUNITS, TestMeasuresystemUI.STEPFACTORS))
        self.assertEquals('6 Yard 1 Feet 1 Inch',
                          add(scale('2', '2 Yard 3 Feet',
                                    TestMeasuresystemUI.SYSUNITS, TestMeasuresystemUI.STEPFACTORS),
                              '13 Inch', TestMeasuresystemUI.SYSUNITS, TestMeasuresystemUI.STEPFACTORS))