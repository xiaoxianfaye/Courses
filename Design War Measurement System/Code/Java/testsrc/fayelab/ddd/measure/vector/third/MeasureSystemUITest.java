package fayelab.ddd.measure.vector.third;

import junit.framework.TestCase;

import static java.util.Arrays.asList;

import fayelab.ddd.measure.vector.third.IllegalParametersException;
import fayelab.ddd.measure.vector.third.MeasureSystemUI;
...
public class MeasureSystemUITest extends TestCase
{
    ...
    public void test_parseQuantity()
    {
        ...
        assertEquals(asList(1, 2, 0, 4), ui.parseQuantity("1 Mile 2 Yard 4 Inch"));
        assertEquals(asList(0, 0, 3, 0), ui.parseQuantity("3 Feet"));        
    }
    ...
    public void test_scale()
    {
        ...
        assertEquals("6 Yard 1 Feet 1 Inch", ui.add(ui.scale("2", "2 Yard 3 Feet"), "13 Inch"));
    }
}
