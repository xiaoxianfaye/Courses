...
public class PresenterTest extends TestCase
{
    ...
    public void test_add_all_transformers_when_chain_is_empty()
    {
        presenter.addAllTransformers();
        assertEquals(asList("Upper", "Lower", "TrimPrefixSpaces"), viewStub.getChainTransIds());
    }
    
    public void test_add_all_transformers_when_chain_is_not_empty()
    {
        viewStub.setSelectedAvailableTransId("Upper");
        presenter.addTransformer();
